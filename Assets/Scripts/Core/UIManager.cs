...
public class UIManager : Singleton<UIManager>
{
    ...
    const string UISWITCHPATH = "UI/UISwitch";
    public UISwitch currentUISwitch = null;
    ...
    public void InitialzieUISwitch()
    {
        UISwitch uISwitch = Instantiate(Resources.Load<UISwitch>(UISWITCHPATH));
        canvas = uISwitch.GetComponent<Canvas>();
        currentUISwitch = uISwitch;
    }
    ...
    private T CreateUI<T>() where T : UIBase
    {
        ...
        // 2. 인스턴스 생성
        GameObject go = Instantiate(prefab, canvas.transform, false);
