...
public class FlowerTypeBehaviour : TileObjectInteraction
{
    public override bool Interaction(Equipment tool, Tile tile, out ChunkData chunkData)
    {
        ...
        MapControl.Instance.map.RandomChunkGen.FlowerType.HarvestDates.Enqueue(TimeManager.Instance.GetActualUpdateDate());
